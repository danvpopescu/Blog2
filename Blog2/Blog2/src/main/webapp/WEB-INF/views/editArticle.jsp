...
<body>
	...
	<div id="blog" align="center">
		...
		<form name='articleForm' action="<c:url value='/saveArticle' />" method='POST'>
			...
			<table>
				...
				<tr>
					<td><input type='text' size="110" name='title' readonly="readonly" value = ${article.title}></td>
				</tr>
				<tr>
					<td>Content:</td>
				</tr>			
				<tr>
					<td><textarea rows="10" cols="110" name='content' >${article.content}</textarea></td>
				</tr>
				<tr>
					<td colspan='2'>
						<input name="saveArticle" type="submit" value="Save" />
