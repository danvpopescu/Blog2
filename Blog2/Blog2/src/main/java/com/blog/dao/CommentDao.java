...
public interface CommentDao {
	...
	/*
	 * find all the comments for the article that has the title parameter as a title and contains the content parameter in the content
	 */
	...
	/*
	 * find all the enabled comments for the article that has the title parameter as a title and contains the content parameter in the content
	 */
